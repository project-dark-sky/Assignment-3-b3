...
public class WaterDrownScript : MonoBehaviour
{
    ...
    {
        if (
            collision.gameObject.layer == playerOneLayer
            || collision.gameObject.layer == playerTwoLayer
        ) //making sure that the player object tuched the coin not other object                                                                      //player1 is layer 3, player2 layer 6
        {
